...
public class CharacterController2D : MonoBehaviour
{
	...
	[SerializeField] public Collider2D m_SitDisableCollider;
	...
	public void Move(float move, bool crouch, bool jump, bool sit)
	{
		...
		if (m_Grounded || m_AirControl)
		{
			...
			else
			{
				...
				if (sit)
				{
					...
					// Reduce the speed by the sitSpeed multiplier
					move *= m_SitSpeed;

					// Disable one of the colliders when sitting
					if (m_SitDisableCollider != null)
						m_SitDisableCollider.enabled = false;
				}
				else
				{
					// Enable the collider when not sitting
					if (m_SitDisableCollider != null)
